...
PLUGIN_NAME = 'ivs_hybrid'


class IvsHybridPlugin(plugin.PluginBase):
    """
    An Indigo Virtual Switch (IVS) VIF type that uses a pair of devices in
    order to allow security group rules to be applied to traffic coming in or
    out of a virtual machine.
    """
